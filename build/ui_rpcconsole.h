...
""));
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "NavajoCoin - Debug window", 0));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the NavajoCoin debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the NavajoCoin-Qt help message to get a list with possible NavajoCoin command-line options.", 0));
#endif // QT_NO_TOOLTIP
